		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?=$good->imgs[0]->path.'?imageView2/2/w/800/800'?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?=$good->imgs[0]->path.'?imageView2/2/w/350/350'?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								...
								<li class="<?=$key>0?"":"cur"?>">
									<a class="<?=$key>0?"":"zoomThumbActive"?>" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$img->path."?imageView2/2/w/350/350"?>',largeimage: '<?=$img->path."?imageView2/2/w/800/800"?>'}"><img src="<?=$img->path.'?imageView2/2/w/50/50'?>"></a>
								</li>
                                <?php endforeach;?>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有<?=rand(10000,99999)?>人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						...
						<div class="desc mt10">
                            ...
                            <?=\backend\models\GoodsIntro::findOne(["goods_id"=>$good->id])->content?>
