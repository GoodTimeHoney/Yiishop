...
<body>
		<!-- 顶部导航 start -->
        <?php
        include  Yii::getAlias("@app")."/views/common/topnav.php";
        ?>
	<!-- 顶部导航 end -->
	...
	<div class="main w1210 bc mt10">
		...
		<div class="content fl ml10">
			<div class="address_hd">
				...
				<dl class="<?=$key==count($addresses)-1?"last":""?>">
					<dt><?=$address->user_name?><?=$address->province?><?=$address->city?><?=$address->area?><?=$address->address?><?=$address->mobile?></dt>
					<dd>
						<a href="">修改</a>
				...
				<form action="" name="address_form" id="add_form">
                    ...
                    <ul>
							<li>
								...
								<input type="text" name="Address[user_name]" class="txt" />
							</li>
							<li>
							...
							<li>
								<label for="">&nbsp;</label>
								<input type="button" name="" class="btn"  id="add_btn" value="保存" />
							</li>
						</ul>
					</form>
			</div>	
		...
		<script>
            ...
            $(function() {
                $("#add_btn").click(function(){
                    $.post("/address/address",$("#add_form").serialize(),function(data) {
                        if(data.status=="1"){
                            layer.msg(data.msg);
                            location.reload();
                        };
