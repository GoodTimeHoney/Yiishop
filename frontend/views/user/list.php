		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
					...
					<li>
						<dl>
							<dt><a href="<?=\yii\helpers\Url::to(["goods/detail","id"=>$good->id])?>"><img src="<?=$good->logo?>" alt="" /></a></dt>
							<dd><a href="<?=\yii\helpers\Url::to(["goods/detail","id"=>$good->id])?>">名称：<?=$good->name?></a></dt>
							<dd><strong>价格：<?=$good->shop_price?>0</strong></dt>
							<dd><a href="<?=\yii\helpers\Url::to(["goods/detail","id"=>$good->id])?>"><em>已有<?=rand(1000,9999)?>人评价</em></a></dt>
						</dl>
					</li>
                 <?php endforeach;?>
				</ul>
