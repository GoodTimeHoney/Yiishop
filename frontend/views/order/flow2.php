				...
				<table>
                    ...
                    <?php foreach ($goods as $good): ?>
						<tr>
							...
							<td class="col3"><?php
                                echo number_format($good->shop_price,2);
                                ?></td>
							<td class="col4"><?=$cart[$good->id]?></td>
							<td class="col5"><span>￥<?php
                                    echo number_format($good->shop_price*$cart[$good->id],2);
                                    ?></span></td>
						</tr>
                    <?php endforeach;?>
					</tbody>
							...
							<td colspan="5">
								<ul>
									...
									<li>
										<span>运费：</span>
										<em >￥
                                            <span id="yunfei">10.00</span>
                                        </em>
									</li>
									<li>
										<span>应付总额：</span>
										<em >
                                            ￥<span id="lastPrice">888888</span>
                                        </em>
									</li>
								</ul>
							</td>
  ...
  <script>
      $(function(){
          $("input[name='delivery']").on("click",function(){
              var fei= $(this).parent().next().text();
              //总金额
               var totalPrice=$("#totalPrice").text()*1;
              //费用
              var result = fei.substring(1)*1;
