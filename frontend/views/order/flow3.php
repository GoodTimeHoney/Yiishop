			...
			<p>
                <?php
                 switch ($order->pay_type_id){
                     ...
                     //微信支付
                     case 2:
                       echo \yii\bootstrap\Html::img(["order/wxin","id"=>$order->id]);
                       break;
                 }

                ?>
            </p>
			<p class="message">完成支付后，你可以 <a href="">查看订单状态</a>  <a href="<?=\yii\helpers\Url::to(["/user/index"])?>">继续购物</a> <a href="">问题反馈</a></p>
		</div>
	</div>
	<!-- 主体部分 end -->
